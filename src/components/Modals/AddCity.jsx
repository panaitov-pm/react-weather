...
class AddCity extends Component {
  ...
  render() {
    ...
    return (
      <Fragment>
        <AddButton onToggleVisibility={this.handleToggleVisibility} />

        <Transition visible={visible} animation="fade" duration={500}>
          <div className="modal-overlay" onClick={this.handleToggleVisibility}>

          </div>
        </Transition>
        <div className={isActive}>
          <div className="modal-window__inner">
            <Header className="modal-window__header" as="h2">Add City</Header>
            <div className="modal-window__content"><AddCityField /></div>
            <button className="modal-window__close" onClick={this.handleToggleVisibility}>
              <svg viewBox="0 0 294.843 294.843" style={{ enableBackground: 'new 0 0 294.843 294.843' }} version="1.1" xmlns="http://www.w3.org/2000/svg">
